...
public class ArtistMusicFragment extends FragmentUtil<FragmentSwipeRecyclerBinding> {
    ...
    public static ArtistMusicFragment newInstance(Artist artist) {
    ...
    public void onViewCreate() {
        ...
        pagination = new PaginateUtil(binding.recyclerView, perPage, page -> rep.latest(artist.getId(),page,perPage));
    ...
    public void onResume() {
        super.onResume();
        rep.latest(artist.getId(), perPage).observe(this, musicAdapter::submitList);
    }

    @Override
    public void onPause() {
        super.onPause();
        rep.latest(artist.getId(), perPage).removeObservers(this);
    }
